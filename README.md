...
```yaml
    environment:
      ...
      - WGCF_VERSION=2.2.22   # Specify wgcf version directly (bypasses GitHub API, recommended for China)
      - GH_PROXY=https://github.ednovas.xyz # Proxy both GitHub API and wgcf binary download
```
...
```yaml
    environment:
      ...
      - WGCF_VERSION=2.2.22   # 直接指定 wgcf 版本号 (跳过 API 请求，国内用户推荐)
      - GH_PROXY=https://github.ednovas.xyz # 代理 GitHub API 版本查询和 wgcf 二进制下载
